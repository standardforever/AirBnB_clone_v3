...
def handle_cities(state_id=None, city_id=None):
    '''handle methods for the cities endpoint.
    '''
    handlers = {
        'GET': get_cities,
        'DELETE': remove_city,
...
def get_cities(state_id=None, city_id=None):
    '''Gets the city by id or all cities with the given state id.
    '''
    if state_id:
